...
public final class ChatServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<chatService.ChatServiceOuterClass.ChatMessage,
      chatService.ChatServiceOuterClass.ChatMessage> getChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "chat",
      requestType = chatService.ChatServiceOuterClass.ChatMessage.class,
      responseType = chatService.ChatServiceOuterClass.ChatMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<chatService.ChatServiceOuterClass.ChatMessage,
      chatService.ChatServiceOuterClass.ChatMessage> getChatMethod() {
    io.grpc.MethodDescriptor<chatService.ChatServiceOuterClass.ChatMessage, chatService.ChatServiceOuterClass.ChatMessage> getChatMethod;
    if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
          ChatServiceGrpc.getChatMethod = getChatMethod =
              io.grpc.MethodDescriptor.<chatService.ChatServiceOuterClass.ChatMessage, chatService.ChatServiceOuterClass.ChatMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "chat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  chatService.ChatServiceOuterClass.ChatMessage.getDefaultInstance()))
  ...
  public static abstract class ChatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<chatService.ChatServiceOuterClass.ChatMessage> chat(
        io.grpc.stub.StreamObserver<chatService.ChatServiceOuterClass.ChatMessage> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                chatService.ChatServiceOuterClass.ChatMessage,
                chatService.ChatServiceOuterClass.ChatMessage>(
                  this, METHODID_CHAT)))
          .build();
    }
  ...
  private static abstract class ChatServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return chatService.ChatServiceOuterClass.getDescriptor();
    }
